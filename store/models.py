...
class VariationManager(models.Manager):
    ...
    def variations(self):
        variation_categories = dict()
        for category, _ in variation_category_choice:
            qs = super(VariationManager, self).filter(
                variation_category=category, is_active=True)
            variation_categories[category] = qs
        return variation_categories
